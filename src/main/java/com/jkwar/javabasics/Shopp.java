...
/**
 * 实现商品库存清单案例 步骤: 1. 实现表头, 是固定数据,直接写输出语句 sop 2. 表格中间, 商品数据,采用变量形式 定义变量,找对数据类型 输出所有变量 3. 表格尾巴,
 * 一部分数据固定 另一部分吗,商品数据进行数学计算,运算符
 */
public class Shopp {
  public static void main(String[] args) {
    ...
    String macBrand = "MacBook Pro";
    double macSize = 15.9;
    double macPrice = 7900.99;
    int macCount = 10;
